...
fn test_minimal_quality_report_against_serialize() -> anyhow::Result<()> {
    ...
    std::fs::write("tests/quality_report_minimal_test_result.xml", xml.replace("https://gitlab.opencode.de/akdb/xoev/xwasser/-/raw/develop/V0_6_0/ xwasser.xsd", "https://gitlab.opencode.de/akdb/xoev/xwasser/-/raw/develop/V0_6_0/ ../schemas/V0_6_0/xwasser.xsd"))?;
    Ok(())
}
