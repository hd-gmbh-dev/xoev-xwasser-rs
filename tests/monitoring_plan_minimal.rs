...
fn test_minimal_monitoring_plan_against_serialize() -> anyhow::Result<()> {
    ...
    dbg!(&xml);
    std::fs::write("tests/monitoring_plan_minimal_test_result.xml", xml.replace("https://gitlab.opencode.de/akdb/xoev/xwasser/-/raw/develop/V0_6_0/ xwasser.xsd", "https://gitlab.opencode.de/akdb/xoev/xwasser/-/raw/develop/V0_6_0/ ../schemas/V0_6_0/xwasser.xsd"))?;
    Ok(())
}
