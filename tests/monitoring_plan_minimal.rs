...
fn test_minimal_monitoring_plan_against_serialize() -> anyhow::Result<()> {
    ...
    dbg!(&xml);
    std::fs::write("tests/monitoring_plan_minimal_test_result.xml", xml.replace("https://gitlab.opencode.de/akdb/xoev/xwasser/-/raw/develop/V0_5_3/ xwasser.xsd", "https://gitlab.opencode.de/akdb/xoev/xwasser/-/raw/develop/V0_5_3/ ../schemas/V0_5_3/xwasser.xsd"))?;
    Ok(())
}
