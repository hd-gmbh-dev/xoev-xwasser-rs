...
fn test_maximal_quality_report_against_serialize() -> anyhow::Result<()> {
    ...
    std::fs::write("tests/quality_report_maximal_test_result.xml", xml.replace("https://gitlab.opencode.de/akdb/xoev/xwasser/-/raw/main/V0_5_0 xwasser.xsd", "https://gitlab.opencode.de/akdb/xoev/xwasser/-/raw/main/V0_5_0 ../schemas/V0_5_0/xwasser.xsd"))?;
    Ok(())
}
