...
function codeNamensartType(): CodeNamensartType {
  return {
    code: "1020",
    list_uri: "",
    list_version_id: "",
...
function organisationseinheitType():OrganisationseinheitType {
  return {
    name: "",
    hierarchieebene: 1,
...
function  analyseergebnisParameter():AnalyseergebnisParameterType {
  return {
...
function behoerdenkennungType(): BehoerdenkennungType {
  return {
    kennung: [],
    praefix: [],
  }
...
function codeBehoerdeType(): CodeBehoerdeType {
  return {
    code: "1020",
    name: "behoerdetype"
  }
...
function zustaendigeBehoerde():ZustaendigeBehoerdeType {
  return {
    id: "1234",
    typ: codeBehoerdeType(),
    zusatz: "",
    behoerdenidentifikation: {
      id: "1234",
      gueltigkeit: zeitraumType("a", "b", ""),
      beschreibung: ""
    },
    behoerdenkennung: behoerdenkennungType(),
...
function codeProbenbewertungType(): CodeProbenbewertungType {
  return {
    code: "1020",
    name: "ty"
  }
...
function probe(): ProbeType {
  return {
    ...
    untersuchungsplan_id: "1345",
    akkreditierte_durchfuehrung_der_probennahme: true,
    konformitaetsbewertung_der_probe: codeProbenbewertungType(),
