...
fn test_minimal_olb_report_against_serialize() -> anyhow::Result<()> {
    ...
    dbg!(&xml);
    std::fs::write("tests/olb_report_minimal_test_result.xml", xml.replace("https://gitlab.opencode.de/akdb/xoev/xwasser/-/raw/develop/V0_9_0/ xwasser.xsd", "https://gitlab.opencode.de/akdb/xoev/xwasser/-/raw/develop/V0_9_0/ ../schemas/V0_9_0/xwasser.xsd"))?;
    Ok(())
}
