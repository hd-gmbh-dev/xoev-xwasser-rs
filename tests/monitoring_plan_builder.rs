...
fn test_monitoring_plan_builder() -> anyhow::Result<()> {
    ...
    std::fs::write("tests/monitoring_plan_builder_test_result.xml", xml.replace(r#"xsi:schemaLocation="https://gitlab.opencode.de/akdb/xoev/xwasser/-/raw/develop/V0_6_0/ xwasser.xsd""#,
