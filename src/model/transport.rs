...
pub struct VorgangTransportieren2010 {
    ...
    #[xml(
        ...
        ty = "attr",
        value = "https://gitlab.opencode.de/akdb/xoev/xwasser/-/raw/develop/V0_5_2/ xwasser.xsd"
    )]
    #[serde(skip)]
    ...
    #[xml(
        ...
        name = b"xwas",
        ty = "attr",
        value = "https://gitlab.opencode.de/akdb/xoev/xwasser/-/raw/develop/V0_5_2/"
    )]
    #[serde(skip)]
    _xmlns: ConstStr,
    ...
    #[xml(name = b"version", ty = "attr", value = "0.5.2")]
    #[serde(skip)]
    _version: ConstStr,
