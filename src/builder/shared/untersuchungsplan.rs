...
pub fn untersuchungsplan_type() -> UntersuchungsplanType {
    ...
    let mut result = UntersuchungsplanType::builder()
        ...
        .beruecksichtigung_lieferketten("1010".into())
        ...
        .vorkommen_cyanobakterien(Default::default())
        ...
        .rau_durchgefuehrt(Default::default())
...
pub fn terminplan_type(probennahmestelle_id: String) -> TerminplanType {
    TerminplanType::builder()
        ...
        .aufnahme_berichtsplan_ga(Default::default())
...
pub fn wasserversorgungsgebiet_type() -> WasserversorgungsgebietType {
    ...
    WasserversorgungsgebietType::builder()
        ...
        .versorgter_ortsteil(Default::default())
        .ueberwachende_behoerde(Default::default())
...
pub fn anlage_nach_trinkw_v_type() -> AnlageNachTrinkwVType {
    AnlageNachTrinkwVType::builder()
        ...
        .versorgter_ortsteil(Default::default())
        .ueberwachende_behoerde(Default::default())
        .anlage_an_die_wasser_abgegeben_wird(Default::default())
